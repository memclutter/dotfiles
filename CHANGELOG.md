...
- Refreshed `README.md` with usage instructions, repo-metadata notes, and status
  badges (latest release, license, managed-with-chezmoi).

### Changed

- Relicensed from GPL-3.0 to MIT, a better fit for freely forking and adapting
  personal dotfiles.
...
[0.0.3]: https://github.com/memclutter/dotfiles/releases/tag/v0.0.3
